...
COMPETITIONS: list[Competition] = [
    Competition(
        ...
        short_title="VTB",
        description="Подписной календарь матчей Единой Лиги ВТБ с автообновлением для Apple Calendar и Google Calendar.",
    ...
    Competition(
        ...
        description="Подписной календарь матчей Единой Молодежной Лиги ВТБ с автообновлением для Apple Calendar и Google Calendar.",
    ...
    Competition(
        ...
        short_title="WCB",
        description="Подписной календарь матчей WINLINE Basket Cup с автообновлением для Apple Calendar и Google Calendar.",
    ...
    Competition(
        ...
        description="Подписной календарь матчей Суперкубка Единой Лиги ВТБ с автообновлением для Apple Calendar и Google Calendar.",
